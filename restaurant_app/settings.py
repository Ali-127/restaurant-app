...
ALLOWED_HOSTS = ['Radical.pythonanywhere.com', 'localhost', '127.0.0.1']
...
# Disabled validators for testing purposes
...
CSRF_TRUSTED_ORIGINS = ['https://Radical.pythonanywhere.com.pythonanywhere.com']
